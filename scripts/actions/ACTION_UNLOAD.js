            ...
            if (map.getTerrain(ACTION_UNLOAD.postAnimationTransportUnitsPosX[i],
                ...
                ACTION_UNLOAD.postAnimationUnit.unloadUnit(ACTION_UNLOAD.postAnimationTransportUnits[i],
                    Qt.point(ACTION_UNLOAD.postAnimationTransportUnitsPosX[i],
                        ...
                        if(unit.getUnitID() == "FAI_IFV_AMPHI" || unit.getUnitID() == "FAI_TRANS_AMPHI") {
                            var unitID = ACTION_UNLOAD.postAnimationUnit.getUnitID();
                            GameConsole.print(unitID,1);
                            if(unitID === "FAI_SHIP_TRANS" ||
                                unitID === "FAI_SHIP_LCA" ||
                                unitID === "FAI_HOVER_TRANS" ||
                                unitID === "FAI_SHIP_ORLYONOK" ||
                                unitID === "FAI_SHIP_EKRANOPLAN") {
