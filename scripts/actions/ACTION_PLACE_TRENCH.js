var Constructor = function()
{
    ...
    this.canBePerformed = function(action)
    {
        ...
        {
            if (ACTION_PLACE_TRENCH.getTrenchFields(action).length > 0)
            {
                return true;
            }
        }
    ...
    this.getStepData = function(action, data)
    {
        ...
        var fields = ACTION_PLACE_TRENCH.getTrenchFields(action);
    ...
    this.perform = function(action)
    {
        ...
        animation.setEndOfAnimationCall("ACTION_PLACE_TRENCH", "performPostAnimation");
        ...
        terrain.loadBuilding("TRENCH");
        terrain.getBuilding().setUnitOwner(unit);
        unit.setHasMoved(true);
        ACTION_PLACE_TRENCH.postAnimationPontoonPosX = x;
        ACTION_PLACE_TRENCH.postAnimationPontoonPosY = y;
    ...
    this.performPostAnimation = function(postAnimation)
    {
        ...
        ACTION_PLACE_TRENCH.postAnimationPontoonPosX = -1;
        ACTION_PLACE_TRENCH.postAnimationPontoonPosY = -1;
    };
}

Constructor.prototype = ACTION;
var ACTION_PLACE_TRENCH = new Constructor();
