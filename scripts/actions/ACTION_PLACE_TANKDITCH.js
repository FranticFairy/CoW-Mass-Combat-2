var Constructor = function()
{
    ...
    this.canBePerformed = function(action)
    {
        ...
        {
            if (ACTION_PLACE_TANKDITCH.getTrenchFields(action).length > 0)
            {
                return true;
            }
        }
    ...
    this.getStepData = function(action, data)
    {
        ...
        var fields = ACTION_PLACE_TANKDITCH.getTrenchFields(action);
    ...
    this.perform = function(action)
    {
        ...
        animation.setEndOfAnimationCall("ACTION_PLACE_TANKDITCH", "performPostAnimation");
        ...
        terrain.loadBuilding("TANKDITCH");
        terrain.getBuilding().setUnitOwner(unit);
        unit.setHasMoved(true);
        ACTION_PLACE_TANKDITCH.postAnimationPontoonPosX = x;
        ACTION_PLACE_TANKDITCH.postAnimationPontoonPosY = y;
    ...
    this.performPostAnimation = function(postAnimation)
    {
        ...
        ACTION_PLACE_TANKDITCH.postAnimationPontoonPosX = -1;
        ACTION_PLACE_TANKDITCH.postAnimationPontoonPosY = -1;
    };
}

Constructor.prototype = ACTION;
var ACTION_PLACE_TANKDITCH = new Constructor();
